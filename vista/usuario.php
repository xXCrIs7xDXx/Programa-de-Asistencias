...
<div class="page-content">
  ...
  <div class="text-right mb-2">
    <a href="fpdf/ReporteUsuario.php" target="_blank" class="btn btn-success"> <i class="fa-solid fa-file-pdf"></i> Generar Reporte </a>
  </div>
    ...
    <tbody>
      ...
      while ($datos = $sql->fetch_object()) { ?>
        ...
        <tr>
          ...
          <td><?= $datos->usuario ?></td>
          <td>
            <a href="" data-toggle="modal" data-target="#exampleModal<?= $datos->id_usuario ?>" class=" btn btn-warning"><i class="fa-regular fa-pen-to-square"></i></a>
