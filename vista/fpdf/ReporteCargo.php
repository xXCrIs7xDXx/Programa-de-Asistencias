...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->SetFillColor(100, 250, 240); //colorFondo
      $this->SetTextColor(0, 0, 0); //colorTexto
      $this->SetDrawColor(163, 163, 163); //colorBorde
      $this->SetFont('Arial', 'B', 11);
      $this->Cell(20, 10, utf8_decode('N°'), 1, 0, 'C', 1);
      $this->Cell(170, 10, utf8_decode('NOMBRE'), 1, 1, 'C', 1);
...
$consulta_reporte_cargo = $conexion->query(" select * from cargo");

while ($datos_reporte = $consulta_reporte_cargo->fetch_object()) {
   $i = $i + 1;
   /* TABLA */
   $pdf->Cell(20, 10, utf8_decode($i), 1, 0, 'C', 0);
   $pdf->Cell(170, 10, utf8_decode($datos_reporte->nombre), 1, 1, 'C', 0);
}
