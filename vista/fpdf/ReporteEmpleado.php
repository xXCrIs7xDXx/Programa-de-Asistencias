...
$consulta_reporte_empleado = $conexion->query("select empleado.nombre,empleado.apellido,empleado.dni,cargo.nombre as 'nomCargo' from empleado inner join cargo ON cargo.id_cargo=empleado.cargo");
...
while ($datos_reporte = $consulta_reporte_empleado->fetch_object()) {
   ...
   $pdf->Cell(50, 10, utf8_decode($datos_reporte->apellido), 1, 0, 'C', 0);
   $pdf->Cell(30, 10, utf8_decode($datos_reporte->dni), 1, 0, 'C', 0);
   $pdf->Cell(40, 10, utf8_decode($datos_reporte->nomCargo), 1, 1, 'C', 0);
